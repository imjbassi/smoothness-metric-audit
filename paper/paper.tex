...
Third, absolute success rates differ by roughly $3\times$ between the two
grids at a matched epoch and evaluation budget, including the oracle
(0.544 vs.\ 0.892), and the diffusion runs in fact saw more samples per
epoch (batch 256 vs.\ 100). An earlier reduced-compute pilot showed a
