...
under diffusion. Absolute rates differ by roughly $3\times$ throughout,
...
\paragraph{What we cannot explain.} Absolute success rates differ by roughly
$3\times$ between the grids at a matched epoch and evaluation budget,
including the oracle (0.544 vs.\ 0.892), and the diffusion runs in fact saw
more samples per epoch (batch 256 vs.\ 100). Our earlier reduced-compute
...
under BC only. And absolute success rates remain roughly $3\times$ lower
under diffusion at a matched epoch and evaluation budget, including the
oracle (0.544 vs.\ 0.892). We previously attributed that gap to
